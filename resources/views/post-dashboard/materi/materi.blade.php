                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="#"><button type="button" class="btn btn-primary"> <i class="bi bi-plus-lg"></i> Tambah Data</button></a> 
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        <a href="{{ route('lihatmateri', ['id' => $item->id]) }}" class="btn btn-warning mb-3" style="margin-right: 5px;">
