...
Route::middleware('auth:admin')->group(function () {
    ...
    Route::get('/lihat-logaktivitas/{logaktivitasid}', [LogaktivitasController::class, 'lihatlogaktivitas'])->name('lihatlogaktivitasadmin');
...
Route::middleware('auth:coach')->group(function () {
    ...
    Route::get('/lihat-logaktivitascoach/{logaktivitasid}', [CoachController::class, 'lihatlogaktivitascoach'])->name('lihatlogaktivitascoach');
